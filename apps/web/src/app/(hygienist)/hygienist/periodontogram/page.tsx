...
import { Activity, Search, ChevronRight, Loader2, User } from 'lucide-react';
...
export default function PeriodontogramPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-white/40">Selecteer een patiënt om het periodontogram te openen.</p>
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {filtered.map(p => (
            <Link
              key={p.id}
              href={`/hygienist/patients/${p.id}/perio`}
